...
const PixelBlastComponent = () => {
  ...
  useEffect(() => {
    ...
    let raf = 0;
    const animate = () => {
      uniforms.uTime.value = timeOffset + clock.getElapsedTime() * 0.5;
  ...
  return <div ref={containerRef} className="pixel-blast-container" aria-label="PixelBlast interactive background" />;
};

export default PixelBlastComponent;
